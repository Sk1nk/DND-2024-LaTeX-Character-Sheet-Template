...
\newcommand{\TransparentImages}[1]{%
	...
	\newbox\chara
        ...
        \newbox\chard
        \savebox\chard{\includegraphics[scale=0.19]{template/images/d_t.png}}
...
\newcommand\AddSpellReady[6]{%
  ...
  \g@addto@macro\SpellsReady{%
    ...
    \entryfont\textcolor{text-color}{#3} &
     \begin{fitbox}{33pt}{10pt}{\normalsize}\entryfont\textcolor{text-color}{\centering #4}\end{fitbox}  &
...
\newcommand{\Size}[1]{\renewcommand{\HeightValue}{#1}}
